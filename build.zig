...
pub fn build(b: *std.Build) void {
    ...
    for (imports.items) |item| lib.root_module.addImport(item.name, item.module);
    ...
    for (imports.items) |item| lib_unit_tests.root_module.addImport(item.name, item.module);
